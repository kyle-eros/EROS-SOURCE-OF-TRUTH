-- =========================================
-- ML SYSTEM MONITORING DASHBOARD QUERIES
-- =========================================
-- Use these queries in Looker/Data Studio/Tableau
-- =========================================

-- 1. SYSTEM HEALTH OVERVIEW
-- Shows current system status and key metrics
...
-- 3. CAPTION PERFORMANCE LEADERBOARD
-- Top performing captions by various metrics
...
-- Monitor the exploration/exploitation ratio
...
-- 5. HOURLY PERFORMANCE PATTERNS
-- Identify best performing hours across system
