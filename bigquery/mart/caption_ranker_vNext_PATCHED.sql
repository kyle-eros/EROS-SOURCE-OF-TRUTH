-- =====================================================
-- CAPTION RANKER WITH UCB EXPLORATION v.Next [PATCHED]
-- =====================================================
-- Fixes: ml_weights join, CROSS JOIN issues, cooldown math,
-- deterministic epsilon, per-slot normalization, price elasticity
-- =====================================================

CREATE VIEW `of-scheduler-proj.mart.caption_ranker_vNext` AS
WITH 
